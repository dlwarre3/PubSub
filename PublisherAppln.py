...
class PublisherAppln ():
  ...
  def driver (self):
    ...
    try:
      ...
      self.logger.debug ("PublisherAppln::driver completed")
  ...
  def invoke_operation (self):
    ...
    try:
      self.logger.debug ("PublisherAppln::invoke_operation")
      ...
      self.logger.debug ("PublisherAppln::invoke_operation completed")
    except Exception as e:
      raise e
  ...
  def register_response (self, reg_resp):
    ...
    try:
      self.logger.debug ("PublisherAppln::register_response")
  ...
  def isready_response (self, isready_resp):
    ...
    try:
      self.logger.debug ("PublisherAppln::isready_response" + str(isready_resp))
      ...
      if not isready_resp.status:
        ...
        self.logger.debug ("PublisherAppln::driver - Status success. Ready to disseminate.")
  ...
  def dump (self):
    ...
    try:
      ...
      self.logger.debug ("     Num Topics: {}".format (self.num_topics))
